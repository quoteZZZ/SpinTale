...
import com.spintale.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = SpinTaleConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // 上传文件路径
            String filePath = SpinTaleConfig.getUploadPath();
            // 上传并返回新文件名称
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = SpinTaleConfig.getProfile();
            // 数据库资源地址
