...
import com.spintale.ai.providers.common.LangChain4jModelProvider;
...
public class OpenAiAutoConfig
{
    ...
    {
        return new LangChain4jModelProvider("openai", AiModelProvider.Type.CHAT, openAiChatModel);
    }
    ...
    {
        return new LangChain4jModelProvider(properties.getProvider(), AiModelProvider.Type.CHAT, openAiCompatibleChatModel);
    }
}
