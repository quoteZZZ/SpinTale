...
public class WeatherTool implements AiTool {
    ...
    public WeatherTool(
            @Value("${spintale.ai.tools.weather.api-key:demo}") String apiKey,
            @Value("${spintale.ai.tools.weather.base-url:https://api.openweathermap.org/data/2.5}") String baseUrl) {
        this.apiKey = apiKey;
