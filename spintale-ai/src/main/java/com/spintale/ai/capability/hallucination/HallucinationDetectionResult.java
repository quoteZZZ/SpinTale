package com.spintale.ai.capability.hallucination;
...
public class HallucinationDetectionResult {
    ...
    public HallucinationDetectionResult() {
     ...
     */
    public static HallucinationDetectionResult from(HallucinationDetectionService.HallucinationResult internalResult) {
    ...
    private static String generateSummary(HallucinationDetectionResult result) {
