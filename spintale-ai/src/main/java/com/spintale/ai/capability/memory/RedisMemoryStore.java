...
import com.spintale.ai.capability.memory.MemoryStore;
...
public class RedisMemoryStore implements MemoryStore {
    ...
    private Map<String, String> memoryToMap(LongTermMemory memory) {
        ...
        map.put("createdAt", memory.getCreatedAt() != null ? memory.getCreatedAt().toString() : "");
        map.put("lastAccessedAt", memory.getLastAccessedAt() != null ? memory.getLastAccessedAt().toString() : "");
        map.put("expiresAt", memory.getExpiresAt() != null ? memory.getExpiresAt().toString() : "");
    ...
    private LongTermMemory mapToMemory(RMap<String, String> map) {
        ...
        memory.setCreatedAt(map.get("createdAt") != null && !map.get("createdAt").isEmpty() ? LocalDateTime.parse(map.get("createdAt")) : null);
        memory.setLastAccessedAt(map.get("lastAccessedAt") != null && !map.get("lastAccessedAt").isEmpty() ? LocalDateTime.parse(map.get("lastAccessedAt")) : null);
        memory.setExpiresAt(map.get("expiresAt") != null && !map.get("expiresAt").isEmpty() ? LocalDateTime.parse(map.get("expiresAt")) : null);
