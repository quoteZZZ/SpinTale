...
public class ContentGenerationService
{
    ...
    public GenerationResponse generate(GenerationRequest request)
    {
        try
        {
            ...
            // 构建完整的提示词
            String fullPrompt = textRequest.getPrompt();
            if (textRequest.getSystemPrompt() != null && !textRequest.getSystemPrompt().isEmpty()) {
                fullPrompt = textRequest.getSystemPrompt() + "\n\n" + fullPrompt;
            }
            
            String content = textGenerationService.generate(resolveAction(contentType), fullPrompt);
